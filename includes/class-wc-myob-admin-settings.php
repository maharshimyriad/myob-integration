...
if (!class_exists('WC_MYOB_Integrations_Settings')):
	...
	class WC_MYOB_Integrations_Settings extends WC_Integration
	{
		...
		public function generate_custom_settings_html($form_fields, $echo = true)
		{
			...
			include_once WC_MYOB_INTEGRATION_PLUGINDIR . '/includes/opmc/template-opmc-admin-settings.php';
		}
		...
		public function init_form_fields()
		{
			...
			$this->form_fields = array(
				...
				'WC_MYOB_company_file_id' => array(
					'title' => __('Company File Pulldown', 'WC-MYOB-setting-tab'),
					'type' => 'select',
				...
				'reload_accounts_list' => array(
					'title' => __('Connect to Company File', 'WC-MYOB-setting-tab'),
					'type' => 'button',
					'custom_attributes' => array(
						'onclick' => '',
					),
				...
				'WC_MYOB_dis_account' => array(
					'title' => __('Discount MYOB Account', 'WC-MYOB-setting-tab'),
					'type' => 'select',
				...
				'allows_handle_discounts' => array(
					'title' => __('Handle Discount', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'allow_sync' => array(
					...
					'description' => __('Clicking this button will begin a process to update the inventory levels for your WooCommerce products so that they match the inventory levels of their corresponding MYOB products in AccountRight (if they exist there)', 'WC-MYOB-setting-tab'),
					'desc_tip' => false,
				),
				'invoice_sync' => array(
					'title' => __('Sync Invoices', 'WC-MYOB-setting-tab'),
					'type' => 'button',
					'custom_attributes' => array(
						'onclick' => '',
					),
					'description' => __('Get Invoices from MYOB', 'WC-MYOB-setting-tab'),
					'desc_tip' => false,
				),
				'customers_sync' => array(
					'title' => __('Sync Customers UID', 'WC-MYOB-setting-tab'),
					'type' => 'button',
					'custom_attributes' => array(
						'onclick' => '',
					),
					'description' => __('Get Customer UID from MYOB', 'WC-MYOB-setting-tab'),
					'desc_tip' => false,
				),
				...
				'customer_email_sync' => array(
					'title' => __('Sync Customer by Email', 'WC-MYOB-setting-tab'),
					'type' => 'input_button',
					'button_text' => __('Sync Customer', 'WC-MYOB-setting-tab'),
					'placeholder' => __('Enter customer email', 'WC-MYOB-setting-tab'),
					'description' => __('Enter a WooCommerce customer email and click the button to sync that customer with MYOB.', 'WC-MYOB-setting-tab'),
					'desc_tip' => false,
					'class' => 'button-secondary',
				),

				'product_sku_sync' => array(
					'title' => __('Sync Product by SKU', 'WC-MYOB-setting-tab'),
					'type' => 'input_button',
					'button_text' => __('Sync Product', 'WC-MYOB-setting-tab'),
					'placeholder' => __('Enter prodcut sku', 'WC-MYOB-setting-tab'),
					'description' => __('Enter a WooCommerce product sku and click the button to sync that product with MYOB.', 'WC-MYOB-setting-tab'),
					'desc_tip' => false,
					'class' => 'button-secondary',
				),

				'product_sku_view' => array(
					'title' => __('View Product by SKU', 'WC-MYOB-setting-tab'),
					'type' => 'input_button',
					'button_text' => __('View Product', 'WC-MYOB-setting-tab'),
					'placeholder' => __('Enter product sku', 'WC-MYOB-setting-tab'),
					'description' => __('Enter a product sku and click to view MYOB product details and tiered pricing.', 'WC-MYOB-setting-tab'),
					'desc_tip' => false,
					'class' => 'button-secondary',
				),
				
			// 		'order_number_sync' => array(
			// 	'title' => __('Sync Order by Number', 'WC-MYOB-setting-tab'),
			// 	'type' => 'input_button',
			// 	'button_text' => __('Sync Order', 'WC-MYOB-setting-tab'),
			// 	'placeholder' => __('Enter order number', 'WC-MYOB-setting-tab'),
			// 	'description' => __('Enter a WooCommerce order number and click the button to sync that order with MYOB.', 'WC-MYOB-setting-tab'),
			// 	'desc_tip' => false,
			// 	'class' => 'button-secondary',
			// ),

				'WC_OPMC_only_sync_item_inventory' => array(
					'title' => __('Only Sync MYOB Item Inventory', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'WC_OPMC_stop_auto_inventory_sync' => array(
					'title' => __('Stop Auto Product Inventory Sync', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'WC_OPMC_do_not_copy_inactive_product_from_myob' => array(
					'title' => __('Do Not copy inactive products from MYOB to WooCommerce', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'WC_OPMC_support_variation_product' => array(
					'title' => __('Support Variation Product in MYOB', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'WC_OPMC_auto_copy_customer_from_myob' => array(
					'title' => __('Automatically copy Customer Cards from MYOB to WooCommerce', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'WC_MYOB_search_by_customer_name' => array(
					'title' => __('Search Customer by Name', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'WC_MYOB_search_by_company' => array(
					'title' => __('Search Customer by Company Name', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'WC_MYOB_search_by_email' => array(
					'title' => __('Search Customer by Email', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'WC_OPMC_enable_product_bulk_action' => array(
					'title' => __('Enable Product Sync Bulk Action', 'WC-MYOB-setting-tab'),
					'type' => 'checkbox',
				...
				'WC_OPMC_sync_log_retention' => array(
					...
					'options'     => array(
						...
						'60'  => __( '2 Months',  'WC-MYOB-setting-tab' ),
						'90'  => __( '3 Months',  'WC-MYOB-setting-tab' ),
						'180' => __( '6 Months',  'WC-MYOB-setting-tab' ),
						'270' => __( '9 Months',  'WC-MYOB-setting-tab' ),
						'365' => __( '1 Year',    'WC-MYOB-setting-tab' ),
					),
				),
			);
		...
		public function generate_input_button_html($key, $data)
		{
			...
			$defaults = array(
				...
				'title' => '',
				'placeholder' => '',
				'button_text' => __('Submit', 'WC-MYOB-setting-tab'),
				'disable' => false,
			);
